$(window).on("load", function () {
    ...
    if($(window).width() < 1280) {
        ...
        $('#pagepiling').pagepiling({
            ...
            anchors: ['home', 'about', 'timeline', 'portfolio', 'certificate','blogs', 'contact'],
            scrollingSpeed: 500,
            easing: 'linear',
            loopBottom: false,
            loopTop: false,
            ...
            navigation: {
                'bulletsColor': '#535353',
                'position': 'right',
                'tooltips': ['Home', 'About', 'Career Timeline', 'Portfolio', 'Certificates', 'Blogs', 'Contact'],
            },
            //events
    ...
    setTimeout(function(){
        ...
        // Show research modal after loading completes
        setTimeout(function() {
            if (typeof window.showResearchModal === 'function') {
                window.showResearchModal();
            }
        }, 500); // Small delay after loader disappears
    }, 1200);
...
/****/
 ...
 TweenMax.staggerFrom(".side-footer ul li", 1.5, {
  ...
  TweenMax.from(".side-footer p", 2, {
    ...
    // profile  subname changes
    // document.addEventListener("DOMContentLoaded", function () {
    //     const roles = ["web developer", "software developer", "AI programmer"];
...
document.addEventListener("DOMContentLoaded", function () {
        var typed = new Typed(".typing", {
            strings: ["Web Developer", "Software Developer", "AI Programmer", " UX-Designer", "Web Developer"],
            typeSpeed: 100,
            backSpeed: 60,
            loop: true
        });
